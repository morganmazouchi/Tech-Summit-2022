...
Setting up your DLT Pipeline 

Here is a setting example including the python UDF and the SQL function. Note the multiple entries (1 per notebook) in the "libraries" option:

{
    "id": "95f28631-1884-425e-af69-05c3f397dd90",
    "name": "field_demos_retail",
    "storage": "/Users/quentin.ambard@databricks.com/field_demos_retail/dlt",
    "configuration": {
    ...
    "libraries": [
        {
            "notebook": {
                "path": "/Repos/quentin.ambard@databricks.com/field-demo/demo-retail/02-Delta-Live-Table/02.1bis-SQL-Delta-Live-Table-Python-UDF"
            }
        },
        {
            "notebook": {
                "path": "/Repos/quentin.ambard@databricks.com/field-demo/demo-retail/02-Delta-Live-Table/02.1-SQL-Delta-Live-Table-Ingestion"
            }
        }
    ],
    "target": "retail_quentin_ambard",
    "continuous": false,
    "development": false
}
